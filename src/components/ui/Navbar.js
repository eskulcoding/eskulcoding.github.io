    ...
    return (
        <header className="w-full flex items-center justify-between px-8 sm:px-12 md:px-20 lg:px-32 2xl:pl-64 2xl:px-72 py-5 bg-white fixed z-50">
            ...
            <button className="md:hidden flex flex-col space-y-1 group">
                ...
                <ul className="bg-white shadow-lg w-full flex flex-col absolute left-0 pt-8 pb-10 -top-[100vh] group-focus:top-0 duration-200">
                    <div className="flex justify-end h-6 px-10 mb-5">
                    ...
                    <li className="px-5 py-2"> 
                        <Link href={"/"} className="bg-neutral-100 rounded-lg hover:text-neutral-100 duration-200 py-5 w-full flex justify-center hover:bg-neutral-600 focus:bg-neutral-600">
                            Tentang Kami
                        </Link>
                    </li>
                    <li className="px-5 py-2"> 
                        <Link href={"/album"} className="bg-neutral-100 rounded-lg hover:text-neutral-100 duration-200 py-5 w-full flex justify-center hover:bg-neutral-600 focus:bg-neutral-600">
                            Album
                        </Link>
                    </li>
                    <li className="px-5 py-2"> 
                    ...
                    <li className="px-5 py-2"> 
                        <Link href={"https://www.instagram.com/smadhi_coding"} className="bg-neutral-100 rounded-lg hover:text-neutral-100 duration-200 py-5 w-full flex justify-center hover:bg-neutral-600 focus:bg-neutral-600">
                            Media sosial                            
                        </Link>
                    </li>
                </ul>
