const VisiMisi = () => {
    return (
        <section className="px-8 sm:px-12 md:px-24 lg:px-36 2xl:px-72 py-20 md:py-40 h-fit lg:py-32 flex flex-col md:flex-row space-y-7 md:space-y-0 md:space-x-12 bg-neutral-100">
